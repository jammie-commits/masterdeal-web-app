...
const PropertyDetails = () => {
  ...
  const generateWhatsAppLink = () => {
    ...
    const whatsappURL = `https://wa.me/qr/L3RFSC26VCZ2A1?text=${encodedMessage}`;
    return whatsappURL;
  };
    ...
    <Section>
      <Container>
        ...
        <ContactSection>
          ...
          <WhatsAppLink href="https://wa.me/qr/L3RFSC26VCZ2A1" target="_blank" rel="noopener noreferrer">
            <WhatsAppIcon />
