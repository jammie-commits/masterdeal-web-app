...
const properties = [
  ...
  { id: 8, image: property8, title: 'Green Valley Phase-1', price: 'KES 180,000', description: 'Prime location with excellent amenities and infrastructure.', availability: 'Available', size: '50x100', location: 'Thika', deposit: '40K', balancePeriod: '6 months' },
  { id: 9, image: property9, title: 'Green Valley Phase-2', price: 'KES 200,000', description: 'Modern development with all essential amenities.', availability: 'Available', size: '50x100', location: 'Thika', deposit: '50K', balancePeriod: '6 months' },
  { id: 10, image: property10, title: 'Sunset Gardens Phase-1', price: 'KES 150,000', description: 'Beautiful location with great potential for investment.', availability: 'Available', size: '50x100', location: 'Nakuru', deposit: '30K', balancePeriod: '6 months' },
  { id: 11, image: property11, title: 'Sunset Gardens Phase-2', price: 'KES 170,000', description: 'Premium development with excellent amenities.', availability: 'Available', size: '50x100', location: 'Nakuru', deposit: '40K', balancePeriod: '6 months' },
  { id: 12, image: property12, title: 'Mountain View Estate', price: 'KES 350,000', description: 'Premium location with stunning mountain views.', availability: 'Available', size: '50x100', location: 'Nanyuki', deposit: '70K', balancePeriod: '6 months' },
  { id: 13, image: property13, title: 'Lake View Gardens', price: 'KES 280,000', description: 'Serene environment with lake views and modern amenities.', availability: 'Available', size: '50x100', location: 'Naivasha', deposit: '60K', balancePeriod: '6 months' },
  { id: 14, image: property14, title: 'Coastal Paradise Phase-1', price: 'KES 120,000', description: 'Beautiful coastal location with great investment potential.', availability: 'Available', size: '50x100', location: 'Malindi', deposit: '25K', balancePeriod: '6 months' },
  { id: 15, image: property15, title: 'Coastal Paradise Phase-2', price: 'KES 140,000', description: 'Premium coastal development with excellent amenities.', availability: 'Available', size: '50x100', location: 'Malindi', deposit: '30K', balancePeriod: '6 months' },
  { id: 16, image: property16, title: 'Highland Gardens', price: 'KES 220,000', description: 'Highland location with cool climate and beautiful scenery.', availability: 'Available', size: '50x100', location: 'Narumoru', deposit: '45K', balancePeriod: '6 months' },
  { id: 17, image: property17, title: 'Plains View Estate', price: 'KES 190,000', description: 'Spacious plains location with great development potential.', availability: 'Available', size: '50x100', location: 'Makutano', deposit: '40K', balancePeriod: '6 months' },
  { id: 18, image: property18, title: 'Kilimambogo Heights', price: 'KES 160,000', description: 'Elevated location with panoramic views and modern amenities.', availability: 'Available', size: '50x100', location: 'Kilimambogo', deposit: '35K', balancePeriod: '6 months' },
  { id: 19, image: property19, title: 'Ruiru Gardens Phase-1', price: 'KES 320,000', description: 'Prime location near Nairobi with excellent connectivity.', availability: 'Available', size: '50x100', location: 'Ruiru', deposit: '65K', balancePeriod: '6 months' },
  { id: 20, image: property20, title: 'Ruiru Gardens Phase-2', price: 'KES 340,000', description: 'Premium development with excellent amenities and connectivity.', availability: 'Available', size: '50x100', location: 'Ruiru', deposit: '70K', balancePeriod: '6 months' },
];
